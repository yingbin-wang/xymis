...
public class MyAssignment_wdrwActivity extends BaseList_03_updateActivity {
    ...
    public  void initData(){
        ...
        menu_code = "mytaska";
        menu_name="我的任务";
        mContext = MyAssignment_wdrwActivity.this;
    ...
    public void onTabSelected(ActionBar.Tab tab, FragmentTransaction ft) {
        ...
        if (index == 1){
            ...
            parms2 = "makeempid:" + AppUtils.user.get_zydnId() + ",isDataQxf:1,cxlx:1,parms:completetime is not null ";
        }else if(index == 3){
            parms2 = "makeempid:" + AppUtils.user.get_zydnId() + ",isDataQxf:1,cxlx:1,parms:1=1";
        }
        ...
        parms.put("item_layout",R.layout.list_item_wdrw);
        bundle = AppUtils.setParms("",parms);
        frag.setArguments(bundle);

        FragmentTransaction action = MyAssignment_wdrwActivity.this.getFragmentManager()
                .beginTransaction();
