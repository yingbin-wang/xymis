...
public class Report_FycxbActivity extends Report_BaseActivity  implements View.OnClickListener{
    ...
    public boolean initData() {
        ...
        mContext = Report_FycxbActivity.this;
        pars = "{name:CostSelect,bussinessType:shouji,user_id:" + AppUtils.app_username + ",menuid:"+menuid+",pars:rq<m>"+year+"-"+month+"-01}";
    ...
    public void onClick(View v) {
        ...
        pars = StringUtils.replaceStart(pars,"rq<m>","rq<m>"+year+"-"+month+"-01");
    ...
    public void reshHj() {
        ...
        if (dataMap != null){
            ...
            for (String key:sets) {
                switch (i){
                    case 0:
                        hj.setText("合计 费用金额："+ActivityController.numberToString(dataMap.get(key).toString()));
                        break;
                }
                i++;
            }
