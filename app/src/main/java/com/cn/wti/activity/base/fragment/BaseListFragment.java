...
public class BaseListFragment extends BaseActivity implements ActionBar.TabListener{
            ...
            if (map.get("gldn") != null && !map.get("gldn").toString().equals("")) {
                ...
                if (gldn.equals("")) {
                    ...
                    if (selectMap.get(gldns[0]) != null) {
                        ...
                        String pars = "{pageIndex:0,start:0,limit:10,menu_code:"+menu_code+","+parms1+"}";
                        if(pars.indexOf("~")>=0){
                        ...
                        items = ActivityController.getDialogData(gldns[0].toLowerCase(),method,get_catch(),gldn,col_name,AppUtils.list_limit,pars);
                    }
