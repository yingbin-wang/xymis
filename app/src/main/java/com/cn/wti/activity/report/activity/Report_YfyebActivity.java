...
public class Report_YfyebActivity extends Report_BaseActivity {
    ...
    public boolean initData() {
        ...
        mContext = Report_YfyebActivity.this;
        pars = new ReportParms("0","0", AppUtils.report_limit,"AccPayBalance","",menuid).getParms();
    ...
    public void initView() {
        ...
        hj1_title.setText("合计预付");
        hj2_title.setText("合计应付");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.action_search:
                String parms = new ListParms("0","0",AppUtils.limit,"supplier").getParms();
                Dialog_ViewUtils.showReportCxtj(mContext,"supplier","list",parms,rootView,"sub_name","供应商",mHandler);
            default:
                break;
        }
    ...
    public String getSelectParms(String parms) {
        return  pars.substring(0,pars.length()-1)+"<dh>gys_mcs<m>"+parms+"}";
    }
