...
public class Custom_taskClickListener implements  ClickListener {
    ...
    public Custom_taskClickListener(Context context, List<Map<String,Object>> _dataList,String className){
        this.context = context;
        this._dataList = _dataList;
        this.className = className;
    }

    public Custom_taskClickListener(Context context, List<Map<String,Object>> _dataList,String className,String ywbm){
        this.context = context;
        this._dataList = _dataList;
        this.className = className;
        this.ywbm = ywbm;
    ...
    public Custom_taskClickListener(Context context,UIListTableView tableView,String className,String ywbm){
        this.context = context;
