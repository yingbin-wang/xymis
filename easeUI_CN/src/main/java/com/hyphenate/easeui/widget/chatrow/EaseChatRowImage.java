...
public class EaseChatRowImage extends EaseChatRowFile{
    ...
    private boolean showImageView(final String thumbernailPath, final ImageView iv, final String localFullSizePath,final EMMessage message) {
        ...
        final Bitmap bitmap = EaseImageCache.getInstance().get(thumbernailPath);
        if (bitmap != null) {
            ...
            new AsyncTask<Object, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Object... args) {
                    ...
                    if (file.exists()) {
                        ...
                        Bitmap bitmap1 = null;
                        try {
                            bitmap1 = MyUtils.getBitmapFormUri(imgBody.thumbnailLocalPath());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        return bitmap1;
                        ...
                        return bitmap1;
                       /* return EaseImageUtils.decodeScaleImage(, 160, 160);*/
                    }
                    else {
